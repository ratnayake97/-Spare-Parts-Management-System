...
<div id="body">
<br>
                    <h2 style="text-align:center"><u>Search Bussiness Expenses Here!</u></h2>
                    <br> 
            ...
            <form action="/searchExpense" method="post" >
                ...
                <div class="form-group">
                   ...
                   <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="date" class="form-control" name="exfrom" required>
                        </div>
                    </div>
                        <br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type= "date"  class="form-control" name="exto" required> &nbsp
                            <br>
                        </div>
                    </div>
    ...
    <div class ="col-md-20">
        <table class="table table-info table-striped">
            ...
            <tbody>
                ...
                <tr> 
                    <td>{{$expensesearch -> expense_refno}}</td>
                    <td>{{$expensesearch -> transaction_date}}</td>
                    
                    <td>{{$expensesearch -> expense_category}}</td>
                    
                    <td>{{$expensesearch -> expense_description}}</td>
                    <td>{{$expensesearch -> expense_discount}}</td>
                    <td>{{$expensesearch -> expense_amount}}</td>
