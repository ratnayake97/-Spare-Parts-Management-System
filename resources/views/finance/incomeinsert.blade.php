...
<head>
    ...
    <title>Manage Income Details</title>
</head>
<body>
               ...
               @endforeach
                    ...
                    {{csrf_field()}}
                       <br>
                            ...
                            <input type="hidden" class="form-control" name="invoicenum" >
                            <!--<div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>-->
                            <br>
                        <!-- newly added -->
                            <label class="form-label">Income Reference Number</label>
                            <input type="text" class="form-control" name="inref" placeholder="Enter Reference number">
                            ...
                            <input type="date" class="form-control" name="intransdate" placeholder="Enter Transaction Date">
                            ...
                            <input type="text" class="form-control" name="incomeamount" placeholder="Enter Amount">
                            @error('Income Amount')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                            <br>
                            ...
                            <label class="form-label">Income Category</label>
                                ...
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                                    <option value = "hidden" disabled selected >Select Income Category</option>
                            ...
                            <input type="text" class="form-control" name="indiscount" placeholder="Enter Discount if any">
                            <!-- newly added -->

                            <br>
                            <label class="form-label">Description</label>
                            <input type="text" class="form-control" name="indescription" placeholder="Enter Description">
