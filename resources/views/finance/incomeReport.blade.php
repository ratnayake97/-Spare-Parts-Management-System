...
<div class="container">
    <div class ="col-md-20">
        ...
        <p>Total Income for the period - From <b><i>
            ...
            <table width="100%" style="border-collapse: collapse; border: 0px;">
                <thead class="thead-dark">
                    ...
                    <tr>
                        ...
                        <th style="border: 1px solid; " scope="col">Income Category</th>
                        <th style="border: 1px solid;" scope="col">Income Description</th>
                ...
                <tbody>
                    ...
                    <tr> 
                        <td  style="border: 1px solid;  text-align:left;">{{$incomesearch -> income_refno}}</td>   
                        <td style="border: 1px solid;  text-align:left;">{{$incomesearch -> transaction_date}}</td>
                    
                        <td style="border: 1px solid; text-align:left;">{{$incomesearch -> income_category}}</td>
               
                        <td style="border: 1px solid;  text-align:left;">{{$incomesearch -> income_description}}</td>
                        <td style="border: 1px solid;  text-align:left;">{{$incomesearch -> income_discount}}</td>
                        <td style="border: 1px solid;  text-align:left;">{{$incomesearch -> income_amount}}</td>
                    ...
                    <tr>
                        ...
                        <td style="border: 1px solid; text-align:left;"><b>{{$totalIncome}}.00</b></td>           
                    </tr>
