...
<head>
    ...
    <title>Manage Expense Details</title>
</head>
<body>
            ...
            <div class="col align-self-start">
               ...
               @endforeach
                    ...
                    {{csrf_field()}}
                            ...
                            <input type="hidden" class="form-control" name="paymentnum" >
                            <!--<div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div>-->
                            <br>

                             <!-- newly added -->
                            <label class="form-label">Expense Reference Number</label>
                            <input type="text" class="form-control" name="exref" placeholder="Enter Reference Number">
                            @error('Expense Reference Number')
                            ...
                            <input type="date" class="form-control" name="extransdate" placeholder="Enter Transaction Date">
                            @error('Transaction Date')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                            <br>
                            <label class="form-label">Amount</label>
                            <input type="text" class="form-control" name="expenseamount" placeholder="Enter Amount">
                            ...
                            <label class="form-label">Expense Category</label>
                                ...
                                <span class="text-danger">{{$message}}</span>
                                @enderror     
                                    <option value = "hidden" disabled selected>Select Expense Category</option>
                            ...
                            <input type="text" class="form-control" name="exdiscount" placeholder="Enter Discount if any">
                            <!-- newly added -->

                            <br>
                            <label class="form-label">Description</label>
                            <input type="text" class="form-control" name="exdescription" placeholder="Enter Description">
